...
import com.xkcoding.deadline.common.jackson.DeadlineJavaTimeModule;
 ...
 * @author: yangkai.shen
 * @date: Created in 2019-05-31 15:44
...
public class JacksonUtil {
    ...
    public static <T> List<T> parseArray(String content, Class<T> valueTypeRef) {
        try {
            if (!StrUtil.startWithIgnoreCase(content, StringConstant.LEFT_SQ_BRACKET)) {
    ...
    public static class JacksonObjectMapper extends ObjectMapper {
        ...
        public JacksonObjectMapper() {
            ...
            //日期格式化
            super.registerModule(new DeadlineJavaTimeModule());
            super.findAndRegisterModules();
        }
