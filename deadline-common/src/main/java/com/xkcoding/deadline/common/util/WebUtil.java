...
import com.xkcoding.deadline.common.constants.StringConstant;
...
/**
 * <p>
 * Web 工具类，操作 request/response/cookie 等
 * </p>
 *
 * @package: com.xkcoding.deadline.common.util
 * @description: Web 工具类，操作 request/response/cookie 等
 * @author: yangkai.shen
 * @date: Created in 2019-05-31 15:54
...
public class WebUtil extends org.springframework.web.util.WebUtils {
    ...
    public static String getCookieVal(String name) {
        ...
        Assert.notNull(request, "当前 RequestContextHolder 中不存在 request");
     ...
     */
    private static StringBuilder appendBuilder(StringBuilder sb, CharSequence... strs) {
